...
class _SharedPrefKullanimiState extends State<SharedPrefKullanimi> {
  ...
  var mySharedPrefences; //SharedPreferences mySharedPreferences yaparak alt taraftaki as to as kaldırabilir..
  ...
  void _goster() {
    debugPrint("Okunan isim " +
            (mySharedPrefences as SharedPreferences).getString("myIsim") ??
        "NULLLL");
