...
import 'package:storage_dersleri/model/ogrenci.dart';
...
class DatabaseHelper {
  ...
  Future<int> ogrenciEkle(Ogrenci ogrenci) async {
    ...
    var sonuc = await db.insert(_ogrenciTablo, ogrenci.toMapDB(),
  ...
  Future<int> ogrenciGuncelle(Ogrenci ogrenci) async {
    var db = await _getDatabase();
    var sonuc = await db.update(_ogrenciTablo, ogrenci.toMapDB(),
